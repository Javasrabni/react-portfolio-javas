    ...
    return (
        <div className='Profile'>
            ...
            <div style={Title}>
                ...
                <div style={{width: "110px", height: "110px", flexShrink: "0", flexGrow: "0", backgroundColor: "var(--border)", borderRadius: "100px", display: "grid", placeItems: "start center", objectFit: "cover"}}>
